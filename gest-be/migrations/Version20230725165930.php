...
final class Version20230725165930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE log (id INT NOT NULL, user_id INT DEFAULT NULL, entityclass VARCHAR(255) NOT NULL, entity_id INT NOT NULL, changes JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
