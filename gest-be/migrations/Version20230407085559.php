...
final class Version20230407085559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name VARCHAR(100) NOT NULL, type VARCHAR(15) NOT NULL, grams SMALLINT NOT NULL, days SMALLINT NOT NULL, PRIMARY KEY(id))');
